...
public class DataManager {
    ...
    public void createRadioListForRadioScreen(TableLayout UIRadioList,  ArrayList<String> userRadios, TextView radioListName, TextView radioListLocation) {
        ArrayList<RadioListElement> radioArray = new ArrayList<>();
        ...
        radioArray.add(new RadioListElement(context, "Slam FM", "Netherlands", "http://vip-icecast.538.lw.triple-it.nl:80/SLAMFM_MP3"));
        radioArray.add(new RadioListElement(context, "ABC Hits", "Paris", "http://listen.radionomy.com/abc-hits-music"));
